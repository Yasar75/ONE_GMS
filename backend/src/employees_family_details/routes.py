...
module = "Employee Family Details"
admin_module="Admin"


@employee_family_detail_router.post("/",response_model=EmployeeFamilyDetailRead,status_code=status.HTTP_201_CREATED,dependencies=[Depends(PermissionChecker(module, "c"))])
...
@employee_family_detail_router.put("/{family_uid}",response_model=EmployeeFamilyDetailRead,status_code=status.HTTP_200_OK,dependencies=[Depends(PermissionChecker(module, "u"))])
...
@employee_family_detail_router.get("/",response_model=List[EmployeeFamilyDetailRead],status_code=status.HTTP_200_OK,dependencies=[Depends(PermissionChecker(module, "r"))])
...
@employee_family_detail_router.get("/{family_uid}",response_model=EmployeeFamilyDetailRead,status_code=status.HTTP_200_OK,dependencies=[Depends(PermissionChecker(module, "r"))])
...
@employee_family_detail_router.get("/employee/{employee_uid}",response_model=List[EmployeeFamilyDetailRead],status_code=status.HTTP_200_OK,dependencies=[Depends(PermissionChecker(module, "r"))])
...
@employee_family_detail_router.delete("/{family_uid}",status_code=status.HTTP_200_OK,dependencies=[Depends(AdminOnly)])
