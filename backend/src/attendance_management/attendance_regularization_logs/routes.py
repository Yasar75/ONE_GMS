...
@attendance_regularization_log_router.get("/{regularization_uid}",response_model=List[AttendanceRegularizationLogRead],status_code=status.HTTP_200_OK,dependencies=[role_checker])
